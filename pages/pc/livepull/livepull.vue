		...
		<view class="page-content">
			<div class="video-content common-min-width common-flex">
				...
				<div class="video-right common-mar-r-sm common-size-border">
					...
					<view class="live-content flex-r">
						
						<!-- 播放器 -->
						<view class="live_pull" >
							<view class="pull">
								<view class="uni-video-container" id="myPlayer" @click="transport_g()" ref="video">
						...
						<!-- 主播和观众席信息 -->
						<view class="right-chat-content flex-full">
...
<script>
	import livepullTop from "@/pages/pc/components/livepulltop.vue";
	import livepullChat from "@/pages/pc/components/livepullchat.vue";
	import liveGift from "@/pages/pc/components/livegift.vue";
	...
	export default {
		...
		onLoad(e) {
			...
			this.windowWidth = 600;//sysInfo.screenWidth
		...
		methods: {
			...
			getLivePlayer() {  // 生成需要的video 组件
				...
				// video.style = 'width:50vw;height:90vh;';//'width:50vw;height: '+ this.windowHeight + 'px';
				// //video.controls = true;
				// //video.setAttribute("muted","muted");
				// var source = document.createElement('source');
				// source.src = this.liveinfo.pull;
				...
				player.style = 'width:50vw;height: '+ this.windowHeight + 'px'
...
<style>
	...
	.live-content .live_pull{
		width: 50vw;
		height: 90vh;
	}
	.live-content .live_pull .pull{
		width: 50vw;
		height: 90vh;
	}
	.ugift{
