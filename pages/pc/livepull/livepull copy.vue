...
<script>
	import livepullTop from "@/pages/live/components/livepulltop.vue";
	import livepullChat from "@/pages/live/components/livepullchat.vue";
	import liveGift from "@/pages/live/components/livegift.vue";
